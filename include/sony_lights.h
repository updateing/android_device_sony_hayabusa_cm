...
char const*const LOGO_BACKLIGHT_PATTERN_FILE = "/sys/class/leds/logo-backlight_1/use_pattern";
char const*const LOGO_BACKLIGHT2_PATTERN_FILE = "/sys/class/leds/logo-backlight_2/use_pattern";
